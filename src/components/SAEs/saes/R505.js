...
function SAE505() {
  ...
  return (
    <div style={styles.container}>
      <h1 style={styles.title}>SAE 5.05</h1>
      <p style={styles.description}>
        Cette page est en cours de développement. Revenez bientôt pour découvrir le contenu de la SAE 5.05 !
      </p>
