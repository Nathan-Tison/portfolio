...
function SAE603() {
  ...
  return (
    <div style={styles.container}>
      <h1 style={styles.title}>SAE 6.03</h1>
      <p style={styles.description}>
        Cette page est en cours de développement. Revenez bientôt pour découvrir le contenu de la SAE 6.03 !
      </p>
